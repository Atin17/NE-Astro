...
def run_two_phase_training(
    ...
    astro_vals, weight_norms, performance_phase1, max_steps = train_td_astro_hebb(env_go_only, model, optimizer, 
                                      1, gamma, epsilon, alpha_hebb, dt, T_iti, astro_val, weight_norms, performance_list, max_steps, trial_counter, astro_vals)
    
    astro_vals, weight_norms, performance_phase2, max_steps = train_td_astro_hebb(env_full, model, optimizer,
...
def train_td_astro_hebb(
    ...
    return astro_vals, weight_norms, performance_list, max_steps
